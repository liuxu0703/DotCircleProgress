package lx.af.demo.DotCircleProgress;
 ...
 * date: 16-3-19
 */
public class DotCircleDemo extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dot_circle_btn_anim_progress: {
                ...
                mRunningDigit.setVisibility(View.VISIBLE);
